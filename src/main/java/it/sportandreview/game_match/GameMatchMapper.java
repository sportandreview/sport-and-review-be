...
@Mapper(componentModel = "spring", uses={GameMatch.class, PlayerUserMapper.class, FieldMapper.class, GenderTypeMapper.class,
...
public abstract class GameMatchMapper {
    ...
    @Mapping(target = "genderTeamId", source = "genderTeam.id")
