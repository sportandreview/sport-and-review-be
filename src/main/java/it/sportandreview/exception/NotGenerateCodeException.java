...
@Log4j2
@Getter
public class NotGenerateCodeException extends AbstractThrowableProblem {

    private final String entity;
    private final String value;

    public NotGenerateCodeException(String entity, String value) {
        super(ErrorConstants.INTERNAL_ERROR, "Errore", Status.INTERNAL_SERVER_ERROR, value, null, null, getAlertParameters(entity));
        this.entity = entity;
        this.value = value;
        log.error("error in generation of OTP code- {} ({})", entity, value);
    }
